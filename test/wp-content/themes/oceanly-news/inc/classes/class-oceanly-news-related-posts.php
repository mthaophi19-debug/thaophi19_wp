 ...
 */
class Oceanly_News_Related_Posts extends Oceanly\Customizer {
	/**
	...
	public function sec_related_posts( $wp_customize ) {
		$wp_customize->add_section(
			'sec_related_posts',
			array(
				'title'       => esc_html__( 'Related Posts', 'oceanly-news' ),
				'description' => esc_html__( 'You can configure the related posts options in here.', 'oceanly-news' ),
				'priority'    => 160,
			)
		);
	}
	...
	public function set_related_posts_enable( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Enable Related Posts', 'oceanly-news' ),
			)
		);
	...
	public function set_related_posts_title( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'section'     => 'sec_related_posts',
				'type'        => 'text',
				'label'       => esc_html__( 'Related Posts Title', 'oceanly-news' ),
				'description' => esc_html__( 'You can change the heading of the related posts that are shown below the single post content.', 'oceanly-news' ),
			)
		);
	...
	public function set_related_posts_source( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => array(
					'categories' => esc_html__( 'Categories', 'oceanly-news' ),
					'tags'       => esc_html__( 'Tags', 'oceanly-news' ),
				),
				'label'       => esc_html__( 'Related Posts Based On', 'oceanly-news' ),
				'description' => esc_html__( 'Select the source for related posts to display. Default: Categories', 'oceanly-news' ),
			)
		);
	...
	public function set_related_posts_count( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => $this->count(),
				'label'       => esc_html__( 'Related Posts Count', 'oceanly-news' ),
				'description' => esc_html__( 'Set the number of related posts. Default: 4', 'oceanly-news' ),
			)
		);
	...
	public function set_related_posts_order( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label'       => esc_html__( 'Related Posts Order', 'oceanly-news' ),
	...
	public function set_related_posts_orderby( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label'       => esc_html__( 'Related Posts Order By', 'oceanly-news' ),
				'description' => esc_html__( 'Sort retrieved related posts by parameter. Default: Random Order', 'oceanly-news' ),
			)
		);
	...
	public static function get_related_posts_default( $key = '' ) {
		$default = array(
			'enable'   => true,
			'title'    => esc_html__( 'You may also like', 'oceanly-news' ),
			'source'   => 'categories',
			'count'    => 4,
			'order'    => 'desc',
			'orderby'  => 'rand',
	...
	public function count() {
		return array(
			'1'  => esc_html_x( '1', 'Related Posts Count', 'oceanly-news' ),
			'2'  => esc_html_x( '2', 'Related Posts Count', 'oceanly-news' ),
			'3'  => esc_html_x( '3', 'Related Posts Count', 'oceanly-news' ),
			'4'  => esc_html_x( '4', 'Related Posts Count', 'oceanly-news' ),
			'5'  => esc_html_x( '5', 'Related Posts Count', 'oceanly-news' ),
			'6'  => esc_html_x( '6', 'Related Posts Count', 'oceanly-news' ),
			'7'  => esc_html_x( '7', 'Related Posts Count', 'oceanly-news' ),
			'8'  => esc_html_x( '8', 'Related Posts Count', 'oceanly-news' ),
			'9'  => esc_html_x( '9', 'Related Posts Count', 'oceanly-news' ),
			'10' => esc_html_x( '10', 'Related Posts Count', 'oceanly-news' ),
			'11' => esc_html_x( '11', 'Related Posts Count', 'oceanly-news' ),
			'12' => esc_html_x( '12', 'Related Posts Count', 'oceanly-news' ),
		);
	}
