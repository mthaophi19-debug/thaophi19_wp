...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Oceanly_News_Select_Multiple extends WP_Customize_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'customizer-select-multiple', get_theme_file_uri( 'assets/js/customizer-select-multiple.js' ), array( 'jquery', 'customize-base' ), OCEANLY_NEWS_VERSION, true );
		}
