 ...
 */
class Oceanly_News_Upsell extends Oceanly\Customizer {
	/**
		...
		$wp_customize->add_control(
			new \Oceanly_Upsell_Control(
				...
				array(
					...
					'type'        => 'oceanly-addon',
					'label'       => esc_html__( 'Learn More', 'oceanly-news' ),
					'description' => esc_html__( 'Premium version also includes top header bar, accent color, RGBA colors, fonts selector, multiple header and footer blocks.', 'oceanly-news' ),
